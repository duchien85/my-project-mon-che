 ...
 */
public class PrepViewSplashCmd extends SimpleCommand implements ICommand {
	public void execute(INotification note) {

		SplashScreen activity = (SplashScreen) note.getBody();
		
		SplashMediator moncheMed = new SplashMediator(MediatorNames.SPLASH, activity);
